...
def create_connectors(node_properties, connectors_to_add):
    ...
    for connector in connectors_dict:
        connector_file = os.path.join(params.presto_catalog_dir, connector + '.properties')
...
def delete_connectors(node_properties, connectors_to_delete):
    ...
    for connector in connectors_list:
        connector_file_name = os.path.join(params.presto_catalog_dir, connector + '.properties')
