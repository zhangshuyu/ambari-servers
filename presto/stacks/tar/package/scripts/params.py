...
presto_catalog_dir = presto_node_data_dir + "/etc/catalog"
presto_plugin_dir = presto_node_data_dir + "/plugin"
presto_server_pid = presto_node_data_dir + '/var/run/launcher.pid'
