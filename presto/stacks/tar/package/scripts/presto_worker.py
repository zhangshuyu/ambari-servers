...
class Worker(Script):
    def install(self, env):
        ...
        # Download Presto
        cmd = 'cd {0}; wget {1} -O presto_server.tar.gz'.format(params.presto_base_dir, params.presto_server_download_url)
    ...
    def configure(self, env):
        from params import node_properties, jvm_config, config_properties, \
            config_directory, memory_configs, connectors_to_add, connectors_to_delete, presto_node_data_dir
